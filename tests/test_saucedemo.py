...
def test_login(driver):
    ...
    driver.save_screenshot("evidenia_login_correcto.png")
...
def test_catalogo(driver):
    ...
    driver.save_screenshot("evidencia_existencia_productos.png")
...
def test_carrito(driver):
    ...
    if total_products >= 2:
        ...
        assert badge ==  "2"
    driver.save_screenshot("evidencia_productos_carrito.png")                                                         #busca el elemento del carrito
